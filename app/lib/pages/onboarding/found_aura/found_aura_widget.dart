...
class FoundAuraWidget extends StatefulWidget {
  final Function goNext;

  const FoundAuraWidget({super.key, required this.goNext});

  @override
  State<FoundAuraWidget> createState() => _FoundAuraWidgetState();
}

class _FoundAuraWidgetState extends State<FoundAuraWidget> {
          ...
          child: SafeArea(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  context.l10n.whereDidYouHearAboutAura,
                    ...
                    onPressed: _canContinue
                        ? () {
                            ...
                            final source = _selectedSource == context.l10n.otherSource
                                ...
                                : _selectedSource!;
                            SharedPreferencesUtil().foundAuraSource = source;
