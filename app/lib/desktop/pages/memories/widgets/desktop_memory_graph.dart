...
class DesktopMemoryGraphWidget extends StatefulWidget {
  final VoidCallback? onBack;

  const DesktopMemoryGraphWidget({super.key, this.onBack});

  @override
  State<DesktopMemoryGraphWidget> createState() => DesktopMemoryGraphWidgetState();
}

class DesktopMemoryGraphWidgetState extends State<DesktopMemoryGraphWidget>
