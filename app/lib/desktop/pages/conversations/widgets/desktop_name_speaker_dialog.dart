...
class DesktopNameSpeakerDialog extends StatefulWidget {
  final int speakerId;
  ...
  const DesktopNameSpeakerDialog({
    super.key,
  ...
  @override
  State<DesktopNameSpeakerDialog> createState() => _DesktopNameSpeakerDialogState();
}

class _DesktopNameSpeakerDialogState extends State<DesktopNameSpeakerDialog> {
