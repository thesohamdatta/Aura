...
Aura allows you to stream audio bytes from your DevKit1 or DevKit2 directly to your backend or any other service, enabling you to perform various analyses and store the data. You can also define how frequently you want to receive the audio bytes.
...
1. Create a Google Cloud Storage bucket and set the appropriate permissions. You can follow the steps mentioned [here](https://docs.aura.me/doc/developer/savingaudio) up to step 5.
2. Fork the example repository from [github.com/mdmohsin7/aura-audio-streaming](https://github.com/mdmohsin7/aura-audio-streaming).
...
6. Once the deployment is complete, set the endpoint in the Developer Settings of the Aura App under Realtime audio bytes. The endpoint should be the URL where you deployed the example + `/audio`.
...
We welcome contributions from the open source community! Whether it's improving documentation, adding new features, or reporting bugs, your input is valuable. Check out our [Contribution Guide](https://docs.aura.me/developer/Contribution/) for more information.

## Support 🆘

If you're stuck, have questions, or just want to chat about Aura:

- **GitHub Issues: 🐛** For bug reports and feature requests
- **Community Forum: 💬** Join our [community forum](http://discord.aura.me) for discussions and questions
- **Documentation: 📚** Check out our [full documentation](https://docs.aura.me/) for in-depth guides
