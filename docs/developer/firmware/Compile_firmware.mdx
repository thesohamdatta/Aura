...
description: "Step-by-step guide to compile and install firmware for your AURA device."
---

### Prefer a Pre-Built Firmware?

Navigate to [Flash Device](https://docs.aura.me/doc/get_started/Flash_device) to install a pre-built firmware version.
...
1. **AURA Consumer Version**
   - Open the `firmware/aura` folder
   - Use **nRF Connect** SDK and toolchain version `2.9.0`

2. **AURA DevKit Version**
   - Open the `firmware/devkit` folder
   - Use **nRF Connect** SDK and toolchain version `2.7.0`
...
2. Click "Open an existing application" and navigate to either the `firmware/aura` or `firmware/devkit` folder in the root of this repository, depending on which version you want to build.

   <img
     src="/images/docs/developer/images/install_firmware_screenshot_1.png"
     alt="install_firmware_screenshot_1"
     width="75%"
   />

   <img
     src="/images/docs/developer/images/install_firmware_screenshot_2.png"
...
1.  In the application panel of the extension, click the **Add Build Configuration** icon. Choose a `CMake Preset` that matches your hardware.
    ...
    <img
      src="/images/docs/developer/images/build_configuration.png"
...
<img
  src="/images/docs/developer/images/build_configuration_button.png"
  alt="Build Configuration"
  width="75%"
/>
...
Follow the steps as described [here](https://docs.aura.me/doc/get_started/Flash_device) using the generated file

---

## Congratulations!

You have successfully compiled and installed the firmware on your AURA device.
