...
description: "Submit your app to the Aura app store. Learn the review process, guidelines, and best practices for a successful submission."
---

## Overview

Ready to share your app with the Aura community? Publishing is done directly through the Aura mobile app.
...
<Steps>
  <Step title="Open Aura App" icon="mobile">
    Launch the Aura mobile app on your device
  </Step>
  ...
  <Step title="Complete App Details" icon="file-lines">
    Fill in all required fields: - Name and description - Category selection -
    Capabilities and permissions - Webhook URLs (for integration apps)
  </Step>
...
<Info>
  You can continue to update and test your app while it's under review. Changes
  won't affect the review process.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Privacy First" icon="shield">
    Respect user data, obtain clear consent, and follow data protection best
    practices
  </Card>
...
<CardGroup cols={2}>
  <Card title="Write a Great Description" icon="pen-fancy">
    - Start with what the app does - Explain the value to users - Include usage
    examples - List any requirements
  </Card>
  <Card title="Choose the Right Category" icon="folder">
    - Productivity: Task management, notes, workflows - Health: Fitness,
    wellness, medical - Social: Communication, sharing - Entertainment: Fun,
    games, creativity
  </Card>
  <Card title="Design a Memorable Icon" icon="image">
    - Use simple, recognizable imagery - Ensure visibility at small sizes -
    Match your app's purpose - Avoid text-heavy designs
  </Card>
  <Card title="Plan for Maintenance" icon="wrench">
    - Monitor your webhook uptime - Respond to user feedback - Update for new
    Aura features - Keep your app fresh
  </Card>
</CardGroup>
...
<Steps>
  <Step title="Monitor Performance" icon="chart-line">
    Track your app's install count and user engagement in the Aura app
  </Step>
  ...
  <Step title="Join the Community" icon="discord">
    Connect with other developers in the [Aura Discord](https://discord.gg/aura)
    for support and collaboration
  </Step>
</Steps>

<Tip>
  Successful apps are ones that solve real problems for users. Focus on
  delivering value, and the installs will follow!
</Tip>
