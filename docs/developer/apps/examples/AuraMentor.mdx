---
title: "Aura Mentor"
description: "Get personalized AI mentorship during your conversations with AURA"
---
...
<CardGroup cols={2}>
  <Card
    title="Install App"
    icon="download"
    href="https://h.aura.me/apps/aura-your-mentor-and-teacher-01JCPRSZ7FS40FHFNSJZEWR8R1"
  >
    Install the AURA Mentor app from the AURA App Store
  </Card>
  <Card
    title="View Code"
    icon="code"
    href="https://github.com/BasedHardware/aura/blob/main/plugins/example/notifications/mentor/main.py"
  >
...
<Steps>
  <Step title="Install the App">
    Install the AURA Mentor app in your AURA mobile app
  </Step>
  <Step title="Start Conversations">
    Have natural conversations while wearing your AURA device
  </Step>
...
_[AI listens and analyzes conversation]_

Friend: "What's holding you back?"  
_[Continues collecting context]_

You: "The salary is better but I'd lose my work-life balance..."  
_[AI evaluates if intervention is needed]_
...
1. Install the AURA Mentor app from the AURA App Store
2. Wear your AURA device during conversations
...
**AURA Mentor uses an intelligent message buffering system:**
...
<Check>
  **Privacy Features:** - Only analyzes when you're actively speaking - Doesn't
  interrupt every conversation - Requires specific conditions before providing
  advice - Clears messages after silence periods - No persistent storage of
  conversation content - Session-based processing with automatic cleanup
</Check>
...
<Accordion title="Too many interruptions">
  - The AI is designed to interrupt sparingly - Only sends advice when
  time-sensitive and impactful - Check if multiple problems are being discussed
  in short timeframes
</Accordion>

<Accordion title="Advice not relevant">
  - Ensure your user facts and context are up to date - The AI uses your
  historical data for personalization - Try having more detailed conversations
  about your challenges
</Accordion>

  <Accordion title="App not detecting conversations">
    - Check if AURA device is properly connected
...
<CardGroup cols={3}>
  <Card
    ...
    icon="book"
    href="https://docs.aura.me/doc/developer/apps/Integrations/"
  >
