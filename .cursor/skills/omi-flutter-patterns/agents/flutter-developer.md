...
description: "Flutter Dart app development BLE integration cross-platform iOS Android macOS Windows Provider state management. Use proactively when working on Flutter app, BLE communication, or cross-platform features."
model: inherit
is_background: false
---
