...
Aura Pendant is an open-source smart pendant project that gives you AI capabilities with exceptional battery life.
...
<Info>
<Info>
Watch the announcement video to see Aura Pendant in action.
</Info>
</Info>
...
<Steps>
  <Step title="Open the Firmware">
    Open the [firmware folder](./firmware) and load the `.ino` file in Arduino IDE.

    <Tip>
    Alternatively, follow the [firmware readme](./firmware/README.md) to build using `arduino-cli`.
    </Tip>
  </Step>
