...
def main():
    parser = argparse.ArgumentParser(description='AURA Glass UF2 Builder')
    ...
    if args.output:
        ...
        uf2_path = f"aura_glass_{base_name}.uf2"
