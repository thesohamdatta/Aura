# AURA Glass Firmware Guide

This document provides comprehensive instructions for building, flashing, and managing the AURA Glass firmware.
...
2. **Flash the Firmware:**
   - Copy the generated `aura_glass_firmware.uf2` file to the "ESP32S3" drive.
...
- `aura_glass_firmware.uf2` - Main firmware file (ready to flash).
...
#### **AURA App Battery Display**
The AURA app automatically shows battery percentage when connected to the glasses.
