                            ...
                            uint32_t max_delay_ticks)
{
    ...
    /* Add maximum randaurazation delay to end */
 ...
 *
 * @return int 0: No events are scheduled 1: there is an upcaurang event
 */
int
 ...
 * @param phy_mode
 *
 * @return int 0: Clear for scan req 1: there is an upcaurang event
 */
int
