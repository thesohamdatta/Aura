...
struct os_mempool *
os_mempool_info_get_next(struct os_mempool *mp, struct os_mempool_info *aura)
{
    struct os_mempool *cur;
    ...
    aura->aura_block_size = cur->mp_block_size;
    aura->aura_num_blocks = cur->mp_num_blocks;
    aura->aura_num_free = cur->mp_num_free;
    aura->aura_min_free = cur->mp_min_free;
    strncpy(aura->aura_name, cur->name, sizeof(aura->aura_name) - 1);
    aura->aura_name[sizeof(aura->aura_name) - 1] = '\0';
