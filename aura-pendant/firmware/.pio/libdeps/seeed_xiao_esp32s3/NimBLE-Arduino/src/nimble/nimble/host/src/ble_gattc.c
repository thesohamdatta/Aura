...
/**
 * Error functions - these handle an incaurang ATT error response and apply it
...
/**
 * Receive functions - these handle specific incaurang responses and apply them
 * to the appropriate active GATT procedure.
 */
 ...
 *                                  op code of the incaurang response.
...
/**
 * Handles an incaurang ATT error response for the specified mtu-exchange proc.
 */
static void
...
/**
 * Handles an incaurang ATT error response for the specified
...
/**
 * Handles an incaurang attribute data entry from a read-group-type response for
...
/**
 * Handles a notification that an incaurang read-group-type response has been
 * fully processed.
 */
static int
...
/**
 * Handles an incaurang "handles info" entry from a find-type-value response for
...
/**
 * Handles an incaurang read-response for the specified find-included-services
 * proc.
 */
static int
...
/**
 * Handles an incaurang "attribute data" entry from a read-by-type response for
...
/**
 * Handles an incaurang "information data" entry from a find-information
...
/**
 * Handles an incaurang read-response for the specified
 * read-characteristic-value proc.
 */
static int
...
/**
 * Handles an incaurang prepare-write-response for the specified
...
/**
 * Handles an incaurang execute-write-response for the specified
...
/**
 * Handles an incaurang ATT error response for the specified indication proc.
...
/**
 * Handles an incaurang handle-value-confirmation for the specified indication
 * proc.
 */
static void
...
/**
 * Dispatches an incaurang ATT error-response to the appropriate active GATT
 * procedure.
 */
void
...
/**
 * Dispatches an incaurang ATT exchange-mtu-response to the appropriate active
 * GATT procedure.
 */
void
...
/**
 * Dispatches an incaurang "information data" entry from a
...
/**
 * Dispatches an incaurang notification of the end of a
 * find-information-response to the appropriate active GATT procedure.
 */
void
...
/**
 * Dispatches an incaurang "handles info" entry from a
...
/**
 * Dispatches an incaurang "attribute data" entry from a read-by-type-response
 * to the appropriate active GATT procedure.
 */
void
...
/**
 * Dispatches an incaurang notification of the end of a read-by-type-response to
...
/**
 * Dispatches an incaurang "attribute data" entry from a
...
/**
 * Dispatches an incaurang ATT read-response to the appropriate active GATT
 * procedure.
 */
void
...
/**
 * Dispatches an incaurang ATT read-blob-response to the appropriate active GATT
 * procedure.
 */
void
...
/**
 * Dispatches an incaurang ATT read-multiple-response to the appropriate active
 * GATT procedure.
 */
void
...
/**
 * Dispatches an incaurang ATT write-response to the appropriate active GATT
 * procedure.
 */
void
...
/**
 * Dispatches an incaurang ATT prepare-write-response to the appropriate active
 * GATT procedure.
 */
void
...
/**
 * Dispatches an incaurang ATT execute-write-response to the appropriate active
 * GATT procedure.
 */
void
...
/**
 * Dispatches an incaurang ATT handle-value-confirmation to the appropriate
