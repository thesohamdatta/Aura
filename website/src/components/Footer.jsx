...
export default function Footer({ currentRoute, onNavigate }) {
  ...
  return (
    <footer
      className="tile-parchment border-t border-apple-hairline"
      ...
      <div className="max-w-[980px] mx-auto px-5 py-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 sm:col-span-1">
            <p className="text-apple-tagline text-apple-ink mb-3">aura</p>
            <p className="text-apple-caption text-apple-muted-48 leading-relaxed max-w-[180px]">
          ...
          {Object.entries(links).map(([col, items]) => (
            <div key={col}>
              <p className="text-apple-fine text-apple-muted-80 uppercase tracking-widest mb-3">{col}</p>
                ...
                {items.map((link) => (
                  <li key={link.label}>
                    <a
                      ...
                      className="text-apple-dense-link text-apple-muted-80 hover:text-apple-ink transition-colors duration-150 block leading-[2.2] hover:underline"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-6">
          <p className="text-apple-caption text-apple-muted-48">
            Copyright &copy; 2026 Aura Project. Open-source hardware under CERN-OHL-P.
          </p>
          <div className="flex items-center gap-5">
            <a href="#" className="text-apple-caption text-apple-muted-48 hover:text-apple-ink transition-colors">Privacy Policy</a>
            <a href="/docs" onClick={(e) => handleNav(e, '/docs')} className="text-apple-caption text-apple-muted-48 hover:text-apple-ink transition-colors">Docs</a>
            <a
              href="https://github.com/thesohamdatta/Aura-Wearable-AI"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="View Aura on GitHub"
              className="text-apple-muted-48 hover:text-apple-ink transition-colors"
            >
