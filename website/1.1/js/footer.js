 ...
 * Breadcrumb labels come from js/site-data.js.
 */
(function () {
  function renderFooter() {
    ...
    var html = ''
      + '<footer class="site-footer border-t border-outline-soft/50" style="padding: 64px 0 0 0;">\n'
      + '  <div class="max-w-[var(--content-max)] mx-auto px-margin-base">\n'
      + '\n'
      + '    <!-- Breadcrumb row -->\n'
      + '    <div class="flex items-center text-[12px] text-ink-tertiary pb-4 mb-6 border-b border-outline-soft/35 flex-wrap gap-y-2">\n'
      + '      <a href="index.html" class="hover:text-ink transition-colors">Aura</a>\n'
      + '      <span class="mx-2 text-[10px] text-ink-tertiary">&rsaquo;</span>\n'
      + '      <span class="text-ink">' + breadcrumb + '</span>\n'
      + '    </div>\n'
      + '\n'
      + '    <!-- Main grid -->\n'
      ...
      + '        <div class="font-display text-[21px] font-semibold text-ink mb-2">Aura</div>\n'
      + '      </div>\n'
      + '\n'
      + '      <!-- Build column -->\n'
      + '      <div class="col-span-1">\n'
      + '        <span class="font-body text-[11px] font-medium text-ink/60 mb-4 block">Build</span>\n'
      ...
      + '      <!-- Learn column -->\n'
      + '      <div class="col-span-1">\n'
      + '        <span class="font-body text-[11px] font-medium text-ink/60 mb-4 block">Learn</span>\n'
      + '        <ul class="space-y-0 flex flex-col">\n'
      ...
      + '      <!-- Community column -->\n'
      + '      <div class="col-span-1">\n'
      + '        <span class="font-body text-[11px] font-medium text-ink/60 mb-4 block">Community</span>\n'
      + '        <ul class="space-y-0 flex flex-col">\n'
      ...
      + '      <!-- Project column -->\n'
      + '      <div class="col-span-1">\n'
      + '        <span class="font-body text-[11px] font-medium text-ink/60 mb-4 block">Project</span>\n'
      + '        <ul class="space-y-0 flex flex-col">\n'
      ...
      + '    <div class="pt-6 pb-4 border-t border-outline-soft/35 mt-8 text-[12px] text-ink-tertiary leading-relaxed">\n'
      + '      More ways to build: <a href="https://github.com/thesohamdatta/aura" target="_blank" class="text-accent-blue hover:underline">Fork the GitHub repo</a> or <a href="docs.html" class="text-accent-blue hover:underline">read our assembly guides</a>. Need help? Contact <a href="mailto:thesohamdatta@gmail.com" class="text-accent-blue hover:underline">thesohamdatta@gmail.com</a>.\n'
      + '    </div>\n'
      + '\n'
      + '    <!-- Bottom bar -->\n'
      + '    <div class="border-t border-outline-soft/35 py-5 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">\n'
      + '      <p class="font-body text-[12px] text-ink-tertiary">&copy; 2026 Aura Project. MIT Licensed.</p>\n'
      ...
      + '      </div>\n'
      + '      <span class="font-body text-[12px] text-ink-tertiary">Pune, India</span>\n'
      + '    </div>\n'
      + '\n'
      + '  </div>\n'
      + '</footer>\n';
