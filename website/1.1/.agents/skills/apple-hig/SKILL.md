...
*Completion criterion: You can list all relevant platforms, components, frameworks, and task type from the request.*
...
*Completion criterion: All 16 tier-1 files are loaded and ready for reference.*
...
*Completion criterion: All relevant platform-specific overview files are loaded.*
...
*Completion criterion: All relevant tier-3 files are loaded with no duplicates.*
...
*Completion criterion: All relevant related files from tiers 2 and 3 are loaded.*
...
*Completion criterion: Only specifically matched tier-4 files are loaded.*
...
*Completion criterion: Answer is provided with exact citations from loaded HIG sources, following all non-negotiables.*
