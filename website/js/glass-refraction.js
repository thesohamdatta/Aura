/**
 * glass-refraction.js — SVG Refraction Filter & Scroll-Velocity Distortion
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 2. Accessibility Check: Bypass scroll animations if reduced-motion is requested
  const prefersReducedMotion = window.matchMedia('(prefers-reduced-motion: reduce)').matches;
  if (prefersReducedMotion) {
    return;
  }

  // 3. Dynamic Scroll-Velocity Refraction
  let active = false;
